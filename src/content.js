export const business = {
  ...
  description:
    'A local microbakery making artisan breads and rotating sweet treats in small batches for the Tallahassee community.',
...
export const announcement = {
  ...
  details:
    'Find fresh sourdough, baked goods, and local favorites at Killearn Lakes Taekwondo on Thursdays from 4:00 PM – 7:30 PM, starting April 23, 2026.',
